...
const response = await fetch('https://api.openfiles.com/files/append/logs/app.log', {
  method: 'PUT',
  headers: {
...
response = requests.put(
    'https://api.openfiles.com/files/append/logs/app.log',
...
```bash cURL
curl -X PUT 'https://api.openfiles.com/files/append/logs/app.log' \
