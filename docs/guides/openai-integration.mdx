...
1. **Replace the import** - Change from `openai` to `@openfiles/sdk/openai`
...
<CardGroup cols={2}>
  ...
  <Card title="TypeScript Docs" icon="code" href="/resources/examples">
    TypeScript reference
  </Card>
  <Card title="Python Docs" icon="python" href="/resources/examples">
    Python reference
  </Card>
  <Card title="API Reference" icon="arrow-right" href="/api-reference/quickstart">
