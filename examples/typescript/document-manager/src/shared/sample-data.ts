...
export const salesDataCsv = `Date,Region,Product,Revenue,Units Sold,Customer Type
...
export const customerDataCsv = `Customer ID,Company Name,Industry,Plan Type,Monthly Revenue,Status
...
export const monthlyReportTemplate = `# Monthly Business Report - January 2024
...
// Sample log data
export const applicationLogs = `[2024-01-20 09:15:32] INFO: Application started successfully
...
export const sampleReports = {
  monthlySales: monthlyReportTemplate,

  quarterlyFinancial: `# Q4 2023 Financial Report
...
`,
  ...
  teamStandup: `# Team Standup Meeting - January 15, 2024
...
export function getMonthlyReportPath(month: string, year: string): string {
  return `reports/monthly-sales-${year}-${month.padStart(2, '0')}.md`
}

export function getPolicyPath(policyName: string): string {
  return `policies/${policyName}-policy.md`
}

export function getMeetingNotePath(date: string): string {
  return `meeting-notes/team-standup-${date}.md`
}

// Helper to create sample file paths
export const samplePaths = {
  januarySales: getMonthlyReportPath('01', '2024'),
  februarySales: getMonthlyReportPath('02', '2024'),
  q4Financial: 'reports/quarterly-financial-Q4-2023.md',
  teamStandup: getMeetingNotePath('2024-01-15'),
  remoteWorkPolicy: getPolicyPath('remote-work'),
  dataRetentionPolicy: getPolicyPath('data-retention')
} as const